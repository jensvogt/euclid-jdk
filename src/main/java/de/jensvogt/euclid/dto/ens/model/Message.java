 ...
 */
public record Message(String ern, String topicErn, String messageId, String status, String body,
                      Map<String, Variant> attributes, String contentType, String lastReceived, String created,
                      String modified) {
}
