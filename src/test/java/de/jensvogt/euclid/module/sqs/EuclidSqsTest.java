...
/**
 * Confirms EuclidSqs actually authenticates the way it claims to: SigV4-signed when an access
...
class EuclidSqsTest {
    ...
    void sendMessageSignsWithSigV4WhenAccessKeyConfigured() throws Exception {
        ...
        EuclidSqs sqs = new EuclidSqs(baseUrl(), "unused-token", "eu-central-1", "863459426936", "alice",
    ...
    void sendMessageUsesBearerTokenWhenNoAccessKeyConfigured() throws Exception {
        ...
        EuclidSqs sqs = new EuclidSqs(baseUrl(), "my-jwt-token", "eu-central-1", "863459426936", "alice",
                null, null, null);
        sqs.sendMessage("ern:sqs:eu-central-1:863459426936:queue/test", "hello");
